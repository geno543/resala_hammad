...
const About = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      achievement: 'أسس أستاذ فادي عددًا من الدروس الدينية وبرامج التربية ضمن نشاط أنوار رسالة، ولا يزال يواصل عطاؤه بإيمان وجهد لا ينقطع :)',
      timing: 'مارس 2025',
      // Change this image path to update the image
    ...
    },
    {
      ...
      achievement: 'ضمن جهوده المنتظمة في العمل الخيري، يواصل أستاذ كريم متابعة النشاط الطبي وتوفير وصرف الدواء للمحتاجين... عطاء متواصل يستحق التقدير!',
      timing: 'يناير 2025',
      // Change this image path to update the image
